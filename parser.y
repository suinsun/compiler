...
Formals   :    Variables
          |                     {$$=new List<VarDecl*>;}
          ;
Variables :    Variables ',' Type T_Identifier   {($$=$1)->Append(new VarDecl(new Identifier(@4, $4),$3));}
          |    Type T_Identifier            {($$=new List<VarDecl*>)->Append(new VarDecl(new Identifier(@2, $2), $1));}
          ;
ClassDecl :    T_Class T_Identifier Extend Impl '{' Fields '}'   {$$= new ClassDecl(new Identifier(@2,$2),$3,$4,$6);}
...
Default          :     T_Default ':' Stmts                        {$$=new DefaultStmt($3);}
                 |                                                {$$=NULL;}
                 ;
IfStmt           :     T_If '(' Expr')' Stmt %prec IFX            {$$=new IfStmt($3,$5,NULL);}
